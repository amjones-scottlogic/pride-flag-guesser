...
function Instructions({ onPlayClick }: InstructionsProps) {
  return (
    <div>
      ...
      <div className="flex justify-center content-center pb-8 text-center">{`You have ${MAX_TIME} seconds to name as many pride flags as you can! Can you get all ${FLAGS.length}?`}</div>
      <div className="flex justify-center content-center">
        <button
